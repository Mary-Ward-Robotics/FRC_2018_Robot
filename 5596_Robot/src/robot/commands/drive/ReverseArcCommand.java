...
public class ReverseArcCommand extends TSafeCommand {
	...
	public ReverseArcCommand(double dist, double startDirection, double endDirection, double speed, boolean brake) {
	...
	protected boolean isFinished() {
		...
		if (stopAtDistance) {
			...
			if (encoderDistance / RobotConst.ELEVATOR_ENCODER_COUNTS_PER_INCH > this.dist) {
				return true;
			}
		}
		else {
